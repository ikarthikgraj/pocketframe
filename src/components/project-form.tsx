...
import { ShotDurationSlider } from "@/components/shot-duration-slider";
...
export function ProjectForm() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    const response = await fetch("/api/projects", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ title: form.get("title"), synopsis: form.get("synopsis"), genre: genreValue, languageCode: languageValue || String(form.get("customLanguage") ?? "").trim(), defaultVideoDurationSeconds: duration }) });
